...
export const Univ_Hero_LINEI: Character[] = [
  new Character(
    ...
    [
      {
        Frase:
          "Vou fazer eles serem atingidos com a própria bala... Literalmente.",
      },
      {
        Frase:
          "A maioria das pessoas nunca entenderão a dor de ver seu povo dizimado diante de seus próprios olhos... E nem devem. É para isso que eu luto.",
      },
    ],
